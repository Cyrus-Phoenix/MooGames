...
public class Messages
{
   public static string MooGameWelcomeMessage { get; } = $@"
    ...
    public static string GamesWelcomeMessage { get; } = $@"
             /$$      /$$           /$$                                                   /$$$$$$$$             
            | $$  /$ | $$          | $$                                                  |__  $$__/             
            | $$ /$$$| $$  /$$$$$$ | $$  /$$$$$$$  /$$$$$$  /$$$$$$/$$$$   /$$$$$$          | $$  /$$$$$$       
    ...
    public static string ArenaFighterWelcomeMessage { get; } = $@"
                     █     █░▓█████  ██▓     ▄████▄   ▒█████   ███▄ ▄███▓▓█████    ▄▄▄█████▓ ▒█████                    
                    ▓█░ █ ░█░▓█   ▀ ▓██▒    ▒██▀ ▀█  ▒██▒  ██▒▓██▒▀█▀ ██▒▓█   ▀    ▓  ██▒ ▓▒▒██▒  ██▒                  
                    ▒█░ █ ░█ ▒███   ▒██░    ▒▓█    ▄ ▒██░  ██▒▓██    ▓██░▒███      ▒ ▓██░ ▒░▒██░  ██▒                  
                    ░█░ █ ░█ ▒▓█  ▄ ▒██░    ▒▓▓▄ ▄██▒▒██   ██░▒██    ▒██ ▒▓█  ▄    ░ ▓██▓ ░ ▒██   ██░                  
...
";
    ...
    public static string PressEnterToContinueMessage { get; } = "Press enter to continue.\n";
    ...
    public static string MooGameRules { get; } = @" 
                                                Game Rules
    ...
    public static string GamesMenuOptions { get; } = $@"
                                                Menu 
                                                1 = MooGame
                                                2 = Arena Fighter
                                                3 = World of Moocraft  
